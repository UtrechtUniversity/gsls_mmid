...
- the vector pars is defined, which contains the transmission rate parameter (beta), the recovery rate  (gamma),
- the vector  init contains the initial number of infecteds Y0, the initial number of recovereds Z0, the initial number of susceptibles Y0 population size (30 000) minus the infecteds and recoverds.
...
The rates at which individuals leave the S, I, and R states by death/emigration are mu X,  my Y, and  mu Z, respectively. Birth takes place at rate B. 
